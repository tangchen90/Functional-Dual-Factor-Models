...
for(ij in 1:year_horizon)
{
  jpn.trunc<-list()
  for ( i in 1:47){
    jpn.trunc[[i]]<-extract.ages(extract.years(jpn.data[[i]], years = 1975:(n_year+ij)), 0:100, combine.upper=TRUE)$rate$female
  }
  ...
  res_forc<-cp.forc(jpn.truc, year_horizon = year_horizon, years = 1975:(n_year+ij), ages = 0:100, n_pop =47, K=1)
...
cp.jpfemale.me<-cbind(female_me.Hokkaido , female_me.Aomori , female_me.Iwate ,
...
cp.jpfemale.mae<-cbind(female_mae.Hokkaido , female_mae.Aomori , female_mae.Iwate ,
...
cp.jpfemale.rmse<-cbind(female_rmse.Hokkaido , female_rmse.Aomori , female_rmse.Iwate ,
...
colnames(cp.jpfemale.me)<-c("Hokkaido", "Aomori", "Iwate", "Miyagi", "Akita", "Yamagata", "Fukushima", "Ibaraki",  "Tochigi", "Gunma", "Saitama",  
...
colnames(cp.jpfemale.mae)<-c("Hokkaido", "Aomori", "Iwate", "Miyagi", "Akita", "Yamagata", "Fukushima", "Ibaraki",  "Tochigi", "Gunma", "Saitama",  
                              "Chiba", "Tokyo", "Kanagawa", "Niigata", "Toyama", "Ishikawa", "Fukui", "Yamanashi", "Nagano", "Gifu", "Shizuoka", "Aichi",    
                              "Mie", "Shiga", "Kyoto", "Osaka", "Hyogo", "Nara", "Wakayama", "Tottori", "Shimane", "Okayama", "Hiroshima", "Yamaguchi",
                              "Tokushima", "Kagawa", "Ehime", "Kochi", "Fukuoka", "Saga", "Nagasaki", "Kumamoto", "Oita", "Miyazaki", "Kagoshima", "Okinawa")
colnames(cp.jpfemale.rmse)<-c("Hokkaido", "Aomori", "Iwate", "Miyagi", "Akita", "Yamagata", "Fukushima", "Ibaraki",  "Tochigi", "Gunma", "Saitama",  
                               "Chiba", "Tokyo", "Kanagawa", "Niigata", "Toyama", "Ishikawa", "Fukui", "Yamanashi", "Nagano", "Gifu", "Shizuoka", "Aichi",    
                               "Mie", "Shiga", "Kyoto", "Osaka", "Hyogo", "Nara", "Wakayama", "Tottori", "Shimane", "Okayama", "Hiroshima", "Yamaguchi",
                               "Tokushima", "Kagawa", "Ehime", "Kochi", "Fukuoka", "Saga", "Nagasaki", "Kumamoto", "Oita", "Miyazaki", "Kagoshima", "Okinawa")

write.csv(cp.jpfemale.me, "cp.jpfemale.me.csv")
write.csv(cp.jpfemale.mae, "cp.jpfemale.mae.csv")
write.csv(cp.jpfemale.rmse, "cp.jpfemale.rmse.csv")
