...
for(ij in 1:year_horizon)
{
  ...
  res_forc<-fvp.forc(jpn.truc, year_horizon = year_horizon,ages = 0:100, n_pop =47)
...
fvp.jpmale.me<-cbind(male_me.Hokkaido , male_me.Aomori , male_me.Iwate ,
...
fvp.jpmale.mae<-cbind(male_mae.Hokkaido , male_mae.Aomori , male_mae.Iwate ,
...
fvp.jpmale.rmse<-cbind(male_rmse.Hokkaido , male_rmse.Aomori , male_rmse.Iwate ,
...
colnames(fvp.jpmale.me)<-c("Hokkaido", "Aomori", "Iwate", "Miyagi", "Akita", "Yamagata", "Fukushima", "Ibaraki",  "Tochigi", "Gunma", "Saitama",  
...
colnames(fvp.jpmale.mae)<-c("Hokkaido", "Aomori", "Iwate", "Miyagi", "Akita", "Yamagata", "Fukushima", "Ibaraki",  "Tochigi", "Gunma", "Saitama",  
                              "Chiba", "Tokyo", "Kanagawa", "Niigata", "Toyama", "Ishikawa", "Fukui", "Yamanashi", "Nagano", "Gifu", "Shizuoka", "Aichi",    
                              "Mie", "Shiga", "Kyoto", "Osaka", "Hyogo", "Nara", "Wakayama", "Tottori", "Shimane", "Okayama", "Hiroshima", "Yamaguchi",
                              "Tokushima", "Kagawa", "Ehime", "Kochi", "Fukuoka", "Saga", "Nagasaki", "Kumamoto", "Oita", "Miyazaki", "Kagoshima", "Okinawa")
colnames(fvp.jpmale.rmse)<-c("Hokkaido", "Aomori", "Iwate", "Miyagi", "Akita", "Yamagata", "Fukushima", "Ibaraki",  "Tochigi", "Gunma", "Saitama",  
                               "Chiba", "Tokyo", "Kanagawa", "Niigata", "Toyama", "Ishikawa", "Fukui", "Yamanashi", "Nagano", "Gifu", "Shizuoka", "Aichi",    
                               "Mie", "Shiga", "Kyoto", "Osaka", "Hyogo", "Nara", "Wakayama", "Tottori", "Shimane", "Okayama", "Hiroshima", "Yamaguchi",
                               "Tokushima", "Kagawa", "Ehime", "Kochi", "Fukuoka", "Saga", "Nagasaki", "Kumamoto", "Oita", "Miyazaki", "Kagoshima", "Okinawa")

write.csv(fvp.jpmale.me, "fvp.jpmale.me.csv")
write.csv(fvp.jpmale.mae, "fvp.jpmale.mae.csv")
write.csv(fvp.jpmale.rmse, "fvp.jpmale.rmse.csv")
