...
for(ij in 1:year_horizon)
{
  ...
  res_forc<-mfm.forc(jpn.truc, year_horizon = year_horizon, years = 1973:(n_year+ij), ages = 0:100, n_pop =47)
...
mfm.jpfemale.me<-cbind(female_me.Hokkaido , female_me.Aomori , female_me.Iwate ,
...
mfm.jpfemale.mae<-cbind(female_mae.Hokkaido , female_mae.Aomori , female_mae.Iwate ,
...
mfm.jpfemale.rmse<-cbind(female_rmse.Hokkaido , female_rmse.Aomori , female_rmse.Iwate ,
...
colnames(mfm.jpfemale.me)<-c("Hokkaido", "Aomori", "Iwate", "Miyagi", "Akita", "Yamagata", "Fukushima", "Ibaraki",  "Tochigi", "Gunma", "Saitama",  
...
colnames(mfm.jpfemale.mae)<-c("Hokkaido", "Aomori", "Iwate", "Miyagi", "Akita", "Yamagata", "Fukushima", "Ibaraki",  "Tochigi", "Gunma", "Saitama",  
                              "Chiba", "Tokyo", "Kanagawa", "Niigata", "Toyama", "Ishikawa", "Fukui", "Yamanashi", "Nagano", "Gifu", "Shizuoka", "Aichi",    
                              "Mie", "Shiga", "Kyoto", "Osaka", "Hyogo", "Nara", "Wakayama", "Tottori", "Shimane", "Okayama", "Hiroshima", "Yamaguchi",
                              "Tokushima", "Kagawa", "Ehime", "Kochi", "Fukuoka", "Saga", "Nagasaki", "Kumamoto", "Oita", "Miyazaki", "Kagoshima", "Okinawa")
colnames(mfm.jpfemale.rmse)<-c("Hokkaido", "Aomori", "Iwate", "Miyagi", "Akita", "Yamagata", "Fukushima", "Ibaraki",  "Tochigi", "Gunma", "Saitama",  
                               "Chiba", "Tokyo", "Kanagawa", "Niigata", "Toyama", "Ishikawa", "Fukui", "Yamanashi", "Nagano", "Gifu", "Shizuoka", "Aichi",    
                               "Mie", "Shiga", "Kyoto", "Osaka", "Hyogo", "Nara", "Wakayama", "Tottori", "Shimane", "Okayama", "Hiroshima", "Yamaguchi",
                               "Tokushima", "Kagawa", "Ehime", "Kochi", "Fukuoka", "Saga", "Nagasaki", "Kumamoto", "Oita", "Miyazaki", "Kagoshima", "Okinawa")

write.csv(mfm.jpfemale.me, "mfm.jpfemale.me.csv")
write.csv(mfm.jpfemale.mae, "mfm.jpfemale.mae.csv")
write.csv(mfm.jpfemale.rmse, "mfm.jpfemale.rmse.csv")
