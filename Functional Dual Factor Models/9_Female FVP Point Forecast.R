...
for(ij in 1:year_horizon)
{
  ...
  res_forc<-fvp.forc(jpn.truc, year_horizon = year_horizon, years = 1973:(n_year+ij), ages = 0:100, n_pop =47)
...
fvp.jpfemale.me<-cbind(female_me.Hokkaido , female_me.Aomori , female_me.Iwate ,
...
fvp.jpfemale.mae<-cbind(female_mae.Hokkaido , female_mae.Aomori , female_mae.Iwate ,
...
fvp.jpfemale.rmse<-cbind(female_rmse.Hokkaido , female_rmse.Aomori , female_rmse.Iwate ,
...
colnames(fvp.jpfemale.me)<-c("Hokkaido", "Aomori", "Iwate", "Miyagi", "Akita", "Yamagata", "Fukushima", "Ibaraki",  "Tochigi", "Gunma", "Saitama",  
...
colnames(fvp.jpfemale.mae)<-c("Hokkaido", "Aomori", "Iwate", "Miyagi", "Akita", "Yamagata", "Fukushima", "Ibaraki",  "Tochigi", "Gunma", "Saitama",  
                              "Chiba", "Tokyo", "Kanagawa", "Niigata", "Toyama", "Ishikawa", "Fukui", "Yamanashi", "Nagano", "Gifu", "Shizuoka", "Aichi",    
                              "Mie", "Shiga", "Kyoto", "Osaka", "Hyogo", "Nara", "Wakayama", "Tottori", "Shimane", "Okayama", "Hiroshima", "Yamaguchi",
                              "Tokushima", "Kagawa", "Ehime", "Kochi", "Fukuoka", "Saga", "Nagasaki", "Kumamoto", "Oita", "Miyazaki", "Kagoshima", "Okinawa")
colnames(fvp.jpfemale.rmse)<-c("Hokkaido", "Aomori", "Iwate", "Miyagi", "Akita", "Yamagata", "Fukushima", "Ibaraki",  "Tochigi", "Gunma", "Saitama",  
                               "Chiba", "Tokyo", "Kanagawa", "Niigata", "Toyama", "Ishikawa", "Fukui", "Yamanashi", "Nagano", "Gifu", "Shizuoka", "Aichi",    
                               "Mie", "Shiga", "Kyoto", "Osaka", "Hyogo", "Nara", "Wakayama", "Tottori", "Shimane", "Okayama", "Hiroshima", "Yamaguchi",
                               "Tokushima", "Kagawa", "Ehime", "Kochi", "Fukuoka", "Saga", "Nagasaki", "Kumamoto", "Oita", "Miyazaki", "Kagoshima", "Okinawa")

write.csv(fvp.jpfemale.me, "fvp.jpfemale.me.csv")
write.csv(fvp.jpfemale.mae, "fvp.jpfemale.mae.csv")
write.csv(fvp.jpfemale.rmse, "fvp.jpfemale.rmse.csv")
